...
export default function PopularRecipesPage() {
  ...
  const handleGenerateRecipe = async () => {
    ...
    try {
      const recipePrompt = `Generate a detailed recipe for: "${searchTerm}". Return JSON with: full_title, cooking_time (e.g. "30-45 minutes"), cuisine (from: ${allCuisines.join(', ')}), servings (integer), calories_per_serving (e.g. "350-400 cal"), ingredients (array of strings with quantities), steps (array with title and instruction for each step, include ingredient quantities in instructions).`;
